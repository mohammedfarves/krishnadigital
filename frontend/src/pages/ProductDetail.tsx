              ...
              <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-2">
                {[0, 1, 2, 3].map((i) => (
                  <button
                    ...
                    className={`shrink-0 w-16 h-16 md:w-20 md:h-20 flex items-center justify-center rounded-lg border-2 transition-colors ${
          ...
          <div className="lg:col-span-7">
            ...
            <div className="bg-card rounded-lg border border-border p-4 mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                EMI from <span className="font-medium text-foreground">₹1,999/month</span>
                <span className="text-krishna-blue-link ml-2 cursor-pointer hover:underline">
                  View EMI options
                </span>
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="bg-card rounded-lg border border-border overflow-hidden">
                <table className="w-full text-sm">
                  <tbody>
                    {(showAllSpecs ? specifications : specifications.slice(0, 5)).map((spec, i) => (
                ...
                {specifications.length > 5 && (
                  <button
                    ...
                    className="w-full py-3 text-sm text-krishna-blue-link font-medium flex items-center justify-center gap-1 border-t border-border hover:bg-muted/50"
                  >
            ...
            <div className="mb-6">
              ...
              {reviews.length > 2 && (
                <button
                  ...
                  className="w-full py-3 mt-3 text-sm text-krishna-blue-link font-medium border border-border rounded-lg hover:bg-muted/50"
                >
